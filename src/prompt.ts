...
- when importing packages make sure to use "" for example : import React from "react", also make sure when you use react hooks like useState make sure you add "use client" at the top remember use "".
